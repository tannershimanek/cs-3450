...
def start_prompt(current_dir):
    while True:
        ...
        if action == 'list':
            print(current_dir.accept(ListVisitor()))
        elif action == 'listall':
            print(current_dir.accept(ListAllVisitor()))
        elif action == 'count':
            print(current_dir.accept(CountVisitor()))
        elif action == 'countall':
            print(current_dir.accept(CountAllVisitor()))
        elif action == 'chdir':
            if args:
